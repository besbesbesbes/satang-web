...
function AddTranInputTrip({ trip, setInput, toggleInput }) {
  ...
  return (
    ...
    >
      {/* Skip */}
      <div
        className="h-[45px] bg-prim-6 font-bold flex justify-start items-center gap-1 rounded-[16px] pl-2 border border-prim-1"
        onClick={hdlSkip}
      >
        <SkipIcon

...
const Button = ({ txt, color, Icon }) => (
  <div className=" bg-prim-5 font-bold flex justify-center items-center gap-1 rounded-[16px]">
    <Icon
...
function AddTranInputType() {
  return (
    <div className="w-full h-[50px] bg-prim-6 grid grid-cols-3 font-bold gap-1 p-1 ">
